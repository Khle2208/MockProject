        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-4 mt-3">
                    <div class="logo_footer d-flex justify-content-center align-items-center">
                ...
                <div class="col-md-2 text-start my-5 d-grid h-25 ps-5 ">
                    ...
                    <a href="${pageContext.request.contextPath}/book_list" class="text-decoration-none text-white mb-3">Shop</a>
                </div>
